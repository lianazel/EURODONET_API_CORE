...
// > Déclaraction des modèles de données  <
using EuroDotnet.Model;

namespace EuroDotNet_BusinessRules
{
    // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    // > Cette classe effectue les traitements  divers sur les données  <
    ...
    public class DataProcess
    {
        ...
        public DataProcess(EuroDotNet.Data.DataContext context)
        {
        ...
        public string FactureCalculerNumero(string _Id_Societe)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var NewNumFacture = new DonetFactureCalculNum();
